# Anime-Wallpaper-eCommerce-Demo
College Assignment
...
MySQL – Relational database for storing user accounts and wallpaper data.

HTML5 & CSS3 – Structured content and custom UI design using CSS Grid.

Google Fonts – Integrated typography (Kavoon & Montserrat) to match the anime aesthetic.
...
Application Logic: PHP scripts managing user authentication and the shopping cart.
...
index.php: The main gallery and navigation hub.

signup.php / login.php: User registration and secure authentication.

cart.php: Shopping cart logic and total calculations.
...
Update db.php with your local database credentials if necessary.
